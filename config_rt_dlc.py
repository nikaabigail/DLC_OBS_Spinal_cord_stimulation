...
INFER_W = 1920
INFER_H = 220
INFER_EVERY_N_FRAMES = 2        # компромисс точность/скорость: чаще обновление ключевых точек
TARGET_INFER_FPS = 45.0         # верхний лимит (фактический будет ограничен железом и INFER_EVERY_N_FRAMES)
